...
const pages = ['Info', 'Events', 'Wishlist', 'Services','Gallery','ContactUs'];
const settings = ['Profile', 'Account','Coupans', 'Settings'];
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              ...
              >
                 <Link to={`/${page}`} style={{fontSize: "15.5px" , textDecoration: 'none', color: 'white', fontFamily: 'Algerian', wordSpacing: '.5rem' }}>
                                    {page}</Link>
              </Button>
            ))}
          </Box>
